                        ...
                        <div className="flex-1 text-left">
                          <div className={`text-sm font-semibold flex items-center gap-2 ${isSelected
                            ...
                            {model.id === 'google/gemini-2.0-flash-001' && (
                              <span className="flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-yellow-500/20 text-yellow-500 text-[8px] sm:text-[10px] font-bold border border-yellow-500/30">
